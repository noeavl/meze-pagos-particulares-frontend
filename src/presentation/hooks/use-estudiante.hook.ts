...
import { Estudiante, CreateEstudianteDto, UpdateEstudianteDto } from '../../domain/entities/estudiante.entity';
...
export class useEstudiante {
  ...
  loadEstudiantes() {
    ...
    this.estudianteUseCase.getAllEstudiantes()
      .pipe(
        catchError(err => {
  ...
  getEstudianteById(id: number) {
    ...
    return this.estudianteUseCase.getEstudianteById(id)
      .pipe(
        catchError(err => {
          this.error.set('Error al cargar estudiante: ' + err.message);
          throw err;
        }),
        finalize(() => this.loading.set(false))
      );
  ...
  createEstudiante(estudiante: CreateEstudianteDto) {
    ...
    return this.estudianteUseCase.createEstudiante(estudiante)
      .pipe(
        catchError(err => {
  ...
  updateEstudiante(estudiante: UpdateEstudianteDto) {
    ...
    return this.estudianteUseCase.updateEstudiante(estudiante)
      .pipe(
        catchError(err => {
  ...
  deleteEstudiante(id: number) {
    ...
    return this.estudianteUseCase.deleteEstudiante(id)
      .pipe(
        catchError(err => {
          this.error.set('Error al eliminar estudiante: ' + err.message);
          throw err;
        }),
        finalize(() => this.loading.set(false))
      );
  ...
  searchEstudiantes(term: string) {
    ...
    this.estudianteUseCase.searchEstudiantes(term)
      .pipe(
        catchError(err => {
